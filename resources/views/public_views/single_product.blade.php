			...
			<div class="row s_product_inner">
						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							<ol class="carousel-indicators">
								<li data-target="#carouselExampleIndicators" data-slide-to="0" class="active">
									<img src="../storage/Product_images/{{$product->prod_image}}" width="60" height="60" alt="">
								</li>
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="../storage/Product_images/{{$product->prod_image}}" alt="First slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="../storage/Product_images/{{$product->prod_image}}" alt="Second slide">
								</div>
								<div class="carousel-item">
									<img class="d-block w-100" src="../storage/Product_images/{{$product->prod_image}}" alt="Third slide">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
                        ...
                        <h2>JD{{number_format($product->prod_new_price,2)}}</h2>
                        <h4><del class="text-danger">JD{{number_format($product->prod_new_price,2)}}</del></h4>
                        <ul class="list">
							<li>
								<a class="active" href="#">
                                    <span>Category</span> : {{$product->category->cat_name}}</a>
							</li>
							<li>
								<a href="#">
