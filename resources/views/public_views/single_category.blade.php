	...
	<div class="banner_inner d-flex align-items-center" style="background-size:100% 100% !important;">
		...
		<div class="container">
			<div class="banner_content text-center">
				<h2>{{$single_cat->cat_name}} Category Page</h2>
			</div>
		</div>
	</div>
</section>
			...
			<div class="row flex-row-reverse">
				<div class="col-lg-9">
					<div class="product_top_bar">
						<div class="left_dorp">
							<h3>{{$single_cat->cat_name}} Products</h3>
						...
						<aside class="left_widgets cat_widgets">
							...
							<div class="widgets_inner">
								<ul class="list">
									...
									<li>
										<a href="{{route('categories.show',['id'=>$cat->id])}}" @if ($cat->id == $single_cat->id)
											style="color:blue;"
										@endif >{{$cat->cat_name}}</a>
									</li>
									@endforeach
