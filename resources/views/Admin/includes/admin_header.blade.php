...
<head>
  ...
  <title>LookAlike | Admin Dashboard</title>
...
@endguest
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{route('home')}}" class="brand-link ml-1">
      <img src="{{asset('dist/img/AdminLTELogo.png')}}"style="width:40px !important; height:60px !important;" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Look-Alike (Admin)</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="ml-3">
          <img src="../../storage/Admin_images/{{Auth::user()->image}}" class="img-circle" style="width:40px !important; height:40px !important;" alt="User Image">
        </div>
        <div class="info">
